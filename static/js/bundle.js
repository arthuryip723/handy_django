...
/***/ function(module, exports, __webpack_require__) {
	...
	var _root_container = __webpack_require__(189);
	...
	document.addEventListener('DOMContentLoaded', function () {
	  ...
	  var App = function App() {
	    return _react2.default.createElement(
	      ...
	      { store: store },
	      _react2.default.createElement(_root_container2.default, null)
	    );
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _worker_actions = __webpack_require__(190);
	...
	var mapDispatchToProps = function mapDispatchToProps(dispatch) {
	  return {
	    requestWorkers: function requestWorkers() {
	      return dispatch((0, _worker_actions.requestWorkers)());
	    }
	  };
	};
...
/***/ function(module, exports) {
	...
	var REQUEST_WORKERS = exports.REQUEST_WORKERS = "REQUEST_WORKERS";
	var RECEIVE_WORKERS = exports.RECEIVE_WORKERS = "RECEIVE_WORKERS";
	
	var requestWorkers = exports.requestWorkers = function requestWorkers() {
	  return {
	    type: REQUEST_WORKERS
	  };
	};
	
	var receiveWorkers = exports.receiveWorkers = function receiveWorkers(workers) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var configureStore = function configureStore() {
	  var preloadedState = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { workers: [] };
	  return (0, _redux.createStore)(_root_reducer2.default, preloadedState, (0, _redux.applyMiddleware)(_root_middleware2.default));
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RootReducer = function RootReducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { workers: [] };
	  var action = arguments[1];
	
	  // console.log(state);
	  // console.log(action);
	  switch (action.type) {
	    case _worker_actions.RECEIVE_WORKERS:
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _worker_api_util = __webpack_require__(196);
	...
	exports.default = function (_ref) {
	  ...
	  return function (next) {
	    return function (action) {
	      ...
	      var workersSuccess = function workersSuccess(data) {
	        return dispatch((0, _worker_actions.receiveWorkers)(data.results));
	      };
	      var result = next(action);
	      switch (action.type) {
	        case _worker_actions.REQUEST_WORKERS:
	          (0, _worker_api_util.fetchWorkers)(workersSuccess);
	          break;
	        default:
	          break;
	      }
...
/***/ function(module, exports) {
	...
	var fetchWorkers = exports.fetchWorkers = function fetchWorkers(success) {
	  $.ajax({
	    method: 'GET',
	    url: 'api/workers',
	    success: success
